export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4">
        {`I'm Guilherme, and my love for programming began at the age of 13 when 
      ...
      <p className="mb-4">
        {`Currently, I work as a back-end developer with a degree in 
      ...
      <p className="mb-4">
        {`My quest for growth extends beyond just programming; I am committed 
      ...
      <p className="mb-4">
        {`What truly motivates me is problem-solving. I believe it's 
